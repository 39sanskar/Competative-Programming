...
// Test case 
// 1
// 1: This case is already explained in the problem statement.

// Test case 
// 2
// 2: After processing the first disk, the set of top stack disks are 
// [
// 3
// ]
// [3]. The second disk can be placed on the first stack. Thus, top stack disks are 
// [
// 2
// ]
// [2]. The next 
// 3
// 3 disks can be stacked together. Thus, the top stack disks are 
// [
// 2
// ,
// 2
// ]
// [2,2]. The next two disks can be stacked together to get 
// [
// 2
// ,
// 2
...
// 4
// ]
// [2,2,4]. The next two disks can be stacked together to get 
// [
// 2
// ,
// 2
...
// 7
// ]
// [2,2,4,7]. The last disk can be put on top of the fifth stack. The final stack top are 
// [
// 2
// ,
// 2
...
// Test case 
// 3
// 3: After processing the first disk, the set of top stack disks are 
// [
// 14
// ]
// [14]. The second disk can be placed on the first stack. Thus, top stack disks are 
// [
// 5
// ]
// [5]. The next disk can be placed on second stack to get 
// [
// 5
// ,
// 13
...
// [5,13]. The next 
// 2
// 2 disks can be stacked together. Thus, the top stack disks are 
// [
// 5
// ,
// 13
...
// 17
// ]
// [5,13,17]. The next disk can be placed on second stack to get 
// [
// 5
// ,
// 10
...
// 17
// ]
// [5,10,17]. The next disk can be placed on fourth stack to get 
// [
// 5
// ,
// 10
...
// 18
// ]
// [5,10,17,18]. The last disk can be put on top of the third stack. The final stack top are 
// [
// 5
// ,
// 10
...
int main() {
    ...
    for (int i = 0; i < m; ++i) {
        int customer_max_price = max_prices[i];
        
        auto it = available_tickets.upper_bound(customer_max_price);
        
        if (it != available_tickets.begin()) {
            --it; // Go to the largest price <= customer_max_price
            cout << *it << endl;
            available_tickets.erase(it); // Remove this ticket from available tickets
        } else {
            cout << "-1" << endl;
        }
    }
